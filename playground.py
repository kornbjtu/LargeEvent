...
class MidPoint:
    def __init__(self, node: Node) -> None:
        ...
        self.node = node 
        all_midpoints.append(self)

midpoint1 = MidPoint(33)
midpoint2 = MidPoint(20)
midpoint3 = MidPoint(21)
midpoint4 = MidPoint(22)
midpoint5 = MidPoint(23)
midpoint6 = MidPoint(24)
midpoint7 = MidPoint(25)
midpoint8 = MidPoint(26)
midpoint9 = MidPoint(27)
midpoint10 = MidPoint(28)
midpoint11 = MidPoint(29)
midpoint12 = MidPoint(30)
